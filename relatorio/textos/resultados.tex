...
\subsection{Tempo de Execução}
    ...
    Os resultados de uma execução estão na \red{tab:?}. Por mais que foi apenas uma execução, outros testes obtiveram resultados similares, oscilando no máximo em $\pm 20\%$. Como os valores são bem distintos, isso é o bastante para a análise.
